...
```bash
curl -L -o pabardb.tar.gz \
https://github.com/noerbarry/pabardb/releases/latest/download/pabardb-1.0.0-macos-universal.tar.gz
...
# (opsional) header C API
sudo cp pabardb-1.0.0-macos/include/pabardb.h /usr/local/include/
...
curl -L -o pabardb.tar.gz \
https://github.com/noerbarry/pabardb/releases/latest/download/pabardb-1.0.0-linux-x86_64.tar.gz
...
# (opsional) header C API
sudo cp pabardb-1.0.0-linux/include/pabardb.h /usr/local/include/
